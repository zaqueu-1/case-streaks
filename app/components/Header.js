        ...
        <div className='mx-auto flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-2'>
            <div className='flex items-center space-x-2'>
                <button
                onClick={() => signOut()}
                className='border inline-flex items-center justify-center transition-colors rounded-lg px-4 py-2 text-sm border-primary bg-primary text-secondary font-poppins font-semibold shadow-none whitespace-nowrap'
                >
                Sair
                </button>
            </div>
